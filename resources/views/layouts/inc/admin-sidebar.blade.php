            ...
            <div class="nav">
                ...
                <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        ...
                        <a class="nav-link" href="{{ url('admin/property-condition') }}">Property Conditions</a>
                        <a class="nav-link" href="{{ route('admin.property_status.index') }}">Property Status</a>
                        <a class="nav-link" href="{{ url('admin/price_range') }}">Price Ranges</a>
                ...
                <div class="collapse" id="collapseProperties" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <!-- إضافة عقار جديد -->
                        <a class="nav-link" href="{{ route('admin.property.create') }}">Add Property</a>
                
                        <!-- عرض جميع العقارات -->
                        <a class="nav-link" href="{{ route('admin.property.index') }}">View Properties</a>
                    </nav>
                </div>      
